...
//status=3 ask user msg, if says yes, then call buyProperty(SquareProperty s,Player p)
//status=4 ask user msg, if says yes, then call buildToProperty(SquareProperty s,Player p)
